...
public class Question implements Serializable {
	...
	private List<Kuota> kuotak = new Vector<Kuota>();
	...
	public void addKuota(String S1, double D1) {
		this.kuotak.add(new Kuota(S1,D1,this));
	}
	public List<Kuota> getKuotak(){
		return this.kuotak;
	}
	public Kuota getKuota(int i) {
		return this.kuotak.get(i);
	}
	
	public Kuota getLastKuote() {
		return this.kuotak.get(this.kuotak.size()-1);
	}
	
	@Override
	public boolean equals(Object q) {
		Question q1 = (Question) q;
		return this.questionNumber == q1.getQuestionNumber();
	}
